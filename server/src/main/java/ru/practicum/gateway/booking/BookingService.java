...
import ru.practicum.gateway.exceptions.ItemIsNotAvailableForBookingException;
import ru.practicum.gateway.exceptions.ValidationIdException;
...
import ru.practicum.gateway.user.UserMapper;
import ru.practicum.gateway.user.UserService;
...
public class BookingService {
    ...
    public List<BookingResponseDto> getAllReserve(Long userId, State state, String typeUser, int from, int size) throws Throwable {
