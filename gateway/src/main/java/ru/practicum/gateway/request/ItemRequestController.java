...
public class ItemRequestController {
    ...
    @GetMapping
    public ResponseEntity<Object> getForUser(@RequestHeader(name = "X-Sharer-User-Id") Long userId) {
        log.info("Получен запрос к эндпоинту /requests getForUser с headers {}", userId);
        return requestClient.getForUser(userId);
    }

    @GetMapping("/all")
    public ResponseEntity<Object> getOtherUsers(@RequestHeader(name = "X-Sharer-User-Id") Long userId,
