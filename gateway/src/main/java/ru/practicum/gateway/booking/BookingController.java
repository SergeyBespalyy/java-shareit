...
public class BookingController {
    ...
    @GetMapping
    public ResponseEntity<Object> getAllReservation(@RequestHeader("X-Sharer-User-Id") long userId,
    ...
    @PostMapping
    public ResponseEntity<Object> addReservation(@RequestHeader("X-Sharer-User-Id") long userId,
    ...
    public ResponseEntity<Object> updateStatus(@RequestHeader(name = "X-Sharer-User-Id") Long userId,
    ...
    @GetMapping("/owner")
    public ResponseEntity<Object> getReservationForOwner(@RequestHeader(name = "X-Sharer-User-Id") Long userId,
